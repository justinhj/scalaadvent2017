...
object Day25ImmutableVector {
  ...
  case class TuringMachine(currentSlot: Int, slots : Vector[Int], currentState: Char, program: Program, steps : Int = 0) {
    ...
    def executeOp(op: Op) : TuringMachine = {
      ...
      val updatedSlots = slots.updated(currentSlot, op.writeValue)
